      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <h5 class="centered">{{auth::user()->name}}</h5>
          ...
          <li class="sub-menu">
            ...
            <li><a href="{{route('user-Registration')}}">Add uer</a></li>
    ...
    width: 100%;z-index:0;" --}}
      <div class="text-center">
        ...
        <div class="credits">
          ...
          -->
          Created with Dashio template by <a href="{{asset('public')}}/https://templatemag.com/">TemplateMag</a>
        </div>
        <a href="{{asset('public')}}/index.html#" class="go-top">
